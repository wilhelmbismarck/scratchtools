...
```
exports(obj : dict | list | tuple, config : ExportConfig [optionnal]) # return a str

export(obj : dict | list | tuple, file : pathlib.Path | str, config : ExportConfig [optionnal]) # create / truncatenate a file
```
...
from .exportconfig import ExportConfig, ConfigWarning
from ...exceptions import ExportFileWarning


### Functions
def exports(obj : dict | list | tuple, config : ExportConfig | None = None) -> str :
    """
    # Exports
    ...
    Notice that `encoding` does not affect `exports()` return, only `export()`.
    """
...
def export(obj : dict | list | tuple, path : str, config : ExportConfig = None) :
    """
    # Export
    ...
    Consider checking both `exports()` and `ExportConfig` doc for more details.
    """    
    if not isinstance(config, ExportConfig):
        config = ExportConfig()

    txt  = exports(obj, config)
